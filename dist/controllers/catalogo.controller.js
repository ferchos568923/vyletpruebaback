...
export const listCiudades = async (req, res) => {
    try {
...
export const listEtiquetas = async (req, res) => {
    try {
...
export const listCategoriasProducto = async (req, res) => {
    try {
...
export const listCategoriasEvento = async (req, res) => {
    try {
...
export const listServicios = async (_req, res) => {
    try {
...
export const listTiposInteres = async (_req, res) => {
    try {
