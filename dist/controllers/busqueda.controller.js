...
export const buscarSucursalesPorProducto = async (req, res) => {
    try {
        ...
        const registrar = (s, agrega, tipos) => {
            if (!s)
                return;
        ...
        for (const p of productos) {
            registrar(p.sucursales, (arr) => arr.push({
                id: p.id,
                nombre: p.nombre,
        ...
        for (const h of habitaciones) {
            registrar(h.sucursales, (arr) => arr.push({
                id: h.id,
                nombre: h.nombre,
        ...
        const resultados = Array.from(porSucursal.values())
            ...
            .sort((a, b) => b.productos.length + b.habitaciones.length - (a.productos.length + a.habitaciones.length) ||
